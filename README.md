...
整个项目看起来焕然一新！  
然后，我又重新封装了一下项目，并且将原来的摇一摇加载图片的bug给消除了，同时增加了保存和分享的功能，为了能够可以在Github上就可以直接的看出封装的区别，于是我另开了一个[仓库](https://github.com/sakurajiang/OriginalRestAPP)，用于存储之前的项目，这样在网页上就可以直接看出差别了。  
